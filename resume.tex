...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{mailto:anton.kaminsky@mail.utoronto.ca}{\underline{anton.kaminsky@mail.utoronto.ca}} & \href{https://github.com/nakamin}{\underline{github.com/nakamin}} \\
\end{tabular*}

% \begin{center}
%     {\Huge  Anton Kaminsky}\\\vspace{1pt}
%     \small Toronto, ON ~
%     \href{mailto:anton.kaminsky@mail.utoronto.ca}{\underline{anton.kaminsky@mail.utoronto.ca}} ~ 
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Contributed to production code of a financial auditing application used by top accounting firms}
        ...
        \resumeItem{Proposed and developed a testing tool using Node.js to help catch PDF rendering regressions before release by visually highlighting differences in a repository of PDF documents}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Worked in an Agile environment, participating in meetings, retrospectives and collaborating across teams}
    \resumeItemListEnd
